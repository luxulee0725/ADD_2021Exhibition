...
function randomParams(){
    ...
    document.querySelectorAll('.wrap-slider>input')[ 0 ].value = nf( params.a, 1, 2) ;
    document.querySelectorAll('.wrap-slider>input')[ 1 ].value = nf( params.b, 1, 2) ;
    document.querySelectorAll('.wrap-slider>input')[ 2 ].value = nf( params.c, 1, 2) ;
    document.querySelectorAll('.wrap-slider>input')[ 3 ].value = nf( params.d, 1, 2) ;
}
...
function init(){
    ...
    y = 0;
    controlKit.update();
    document.querySelector('#params').innerHTML =  "<em>a = " + nf( params.a, 1, 3 ) + "</em>" +
         "<em>b = " + nf( params.b, 1, 3 ) + "</em>" +
         "<em>c = " + nf( params.c, 1, 3 ) + "</em>" +
         "<em>d = " + nf( params.d, 1, 3 ) + "</em>";
}
